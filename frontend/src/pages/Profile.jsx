          ...
          <div className="bg-white rounded-xl w-full max-w-md p-6 shadow-lg relative">
            ...
            <div className="relative mb-3">
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-2 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <button
                type="button"
              ...
              >
                <svg className="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={showOldPassword ? "M13.875 18.825a10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21" : "M15 12a3 3 0 11-6 0 3 3 0 016 0z"} />
