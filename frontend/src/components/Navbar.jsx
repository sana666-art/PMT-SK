  ...
  useEffect(() => {
    ...
    const handleHashChange = () => {
      setTimeout(() => {
        ...
        if (['hero', 'features', 'stats'].includes(hash)) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          <Link to="/" className="flex items-center space-x-2 group">
            <img src={Logo} alt="PMT-SK" className="h-10 lg:h-12 object-contain group-hover:scale-105 transition-transform duration-200" />
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {token ? (
              <>
                <Link to="/dashboard" className="text-lg font-semibold text-indigo-600 hover:text-indigo-700 transition-colors px-3 py-2 rounded-lg hover:bg-indigo-50">
                  Dashboard
                </Link>
              ...
              <>
                <Link to="/login" className="text-lg font-medium text-gray-700 hover:text-indigo-600 transition-colors px-3 py-2 rounded-lg hover:bg-indigo-50">
                  Login
                </Link>
                <Link
                  to="/register"
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/50 backdrop-blur-sm">
              ...
              {token ? (
                <>
                  <Link
                    to="/dashboard"
                    className="block px-3 py-2 text-base font-semibold text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-lg"
